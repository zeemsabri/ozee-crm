...
// This is a simple test script to verify that the role update API returns a 200 OK response
// Run this script with: php test-role-api.php
...
// Create a request with the role data
