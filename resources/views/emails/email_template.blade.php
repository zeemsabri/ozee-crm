...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            background-color: #3f35a0 !important;
        }
        .text-link:hover {
...
<body style="margin:0;padding:0;word-spacing:normal;background-color:#f4f7f9;">
<div role="article" aria-roledescription="email" lang="en" style="text-size-adjust:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#f4f7f9;">
                ...
                <table role="presentation" style="width:95%;max-width:600px;border:none;border-spacing:0;text-align:left;background-color:#ffffff;border-radius:16px;box-shadow:0 10px 30px rgba(0,0,0,0.08);margin-top:24px;margin-bottom:24px;">
                    ...
                    <tr>
                        <td align="center" style="padding:40px 30px;font-size:24px;line-height:28px;font-weight:bold;color:#ffffff;border-top-left-radius:16px;border-top-right-radius:16px;
                            ...
                            background-image: linear-gradient(135deg, {{ $brandPrimaryColor ?? '#5d50c6' }} 0%, #3f35a0 100%);">
                    ...
                    <!-- Main Body Content -->
                    <tr>
                        <td style="padding:30px;font-size:16px;line-height:24px;color:#555555;">
                    ...
                    <tr>
                        <td style="padding:0 30px 30px 30px;">
                            <div style="font-family:'Inter',sans-serif;padding:24px;border:1px solid #e5e7eb;background-color:#f9fafb;border-radius:12px;">
                                <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                                    <tr>
                                        <!-- Sender Information -->
                                        <td style="vertical-align:middle;padding-right:20px;">
                                            <p style="margin:0 0 8px 0;font-size:18px;color:#333333;font-weight:600;">Best Regards,</p>
                                            <p style="margin:0;font-size:16px;font-weight:600;color:#333333;">{{ $senderName }}</p>
                                            <p style="margin:5px 0;font-size:14px;color:#555555;">{{ $senderRole }}</p>
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        @if(isset($senderPhone))
                                                            <td style="padding-right:15px;font-size:13px;color:#555555;">📞 <a href="tel:{{ $senderPhone }}" class="text-link" style="color:{{ $textColorSecondary ?? '#555555' }};text-decoration:none;">{{ $senderPhone }}</a></td>
                                                        @endif
                                                ...
                                                <div style="margin-top:15px;text-align:left;">
                                                    @foreach($socialIcons as $social)
                                                        <a href="{{ $social['url'] }}" target="_blank" style="display:inline-block;margin-right:8px;color:{{ $brandPrimaryColor ?? '#5d50c6' }};text-decoration:none;">
                                                            <!-- Using SVG for reliable, scalable icons -->
                    ...
                    <!-- Footer Section -->
                    <tr>
                        <td align="center" style="padding:20px 30px;font-size:12px;line-height:18px;color:#888888;border-top:1px solid #e5e7eb;background-color:#f9fafb;border-bottom-left-radius:16px;border-bottom-right-radius:16px;">
                            ...
                            @endif
                            <p style="margin:5px 0;">Thornlie, WA, 6108 Australia</p>
                        </td>
                    </tr>
                </table>
            </td>
