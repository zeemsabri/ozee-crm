...
const form = useForm({
  name: '',
  description: '',
  scheduled_item_type: props.prefill.scheduled_item_type || 'workflow',
  scheduled_item_id: props.prefill.scheduled_item_id || null,
            ...
            <section>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input v-model="form.name" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g., Weekly workflow run" />
                ...
                <div>
                  ...
                  <input v-model="form.description" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="What will this schedule do?" />
                </div>
              </div>
            </section>
