const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-BEv7z78B.js","assets/app-BYgG_sXM.css"])))=>i.map(i=>d[i]);
import{_ as h}from"./app-BEv7z78B.js";import x from"./BaseModal-BFU1KRL3.js";import{_}from"./MultiSelectDropdown-DpamPPwQ.js";import{a as C}from"./presentationsApi-Dz1_b9-G.js";import{r as a,d as M,y as S,b as k,A as B,o as $,u as A,aG as O,K as m,J as U}from"./vue-entry-BJ7TfIwL.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-x3UR4O1u.js";const T={__name:"CollaborateModal",props:{show:{type:Boolean,default:!1},presentation:{type:Object,required:!0}},emits:["close","updated"],setup(d,{emit:v}){const s=d,r=v,i=a(!1),c=a([]),n=a([]),u=a("editor"),l=a(!1);async function f(){try{i.value=!0;const o=await(typeof window<"u"&&window.axios?window.axios:(await h(async()=>{const{default:t}=await import("./app-BEv7z78B.js").then(w=>w.e);return{default:t}},__vite__mapDeps([0,1]))).default).get("/api/users");c.value=(o.data||[]).map(t=>({value:t.id,label:t.name?`${t.name} <${t.email}>`:t.email}))}catch{m("Failed to load users")}finally{i.value=!1}}M(()=>{f(),p()});function p(){var o;const e=Array.isArray((o=s.presentation)==null?void 0:o.users)?s.presentation.users:[];n.value=e.map(t=>t.id)}S(()=>{var e;return(e=s.presentation)==null?void 0:e.users},()=>{p()});const b=k(()=>!l.value);async function y(){try{l.value=!0;const e=await C.syncCollaborators(s.presentation.id,n.value,u.value);U("Collaborators updated"),r("updated",(e==null?void 0:e.collaborators)||[]),r("close")}catch{m("Failed to update collaborators")}finally{l.value=!1}}const g=O({name:"CollaborateBody",components:{MultiSelectDropdown:_},template:`
    <div class="space-y-4">
      <div>
