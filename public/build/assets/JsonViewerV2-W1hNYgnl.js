import{r as m,b as n,c as g,o as d,a as r,t as h,f as b,g as w,u as x,v as k,n as _,A as y,y as j}from"./vue-entry-DxaYHRqw.js";import{_ as E}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{r as C}from"./MagnifyingGlassIcon-BBXiUP2O.js";import{r as O}from"./CheckIcon-DQZtEuo7.js";import{r as S}from"./ClipboardDocumentIcon-Dvx75R-Q.js";import"./app-CuJvXVX4.js";import"./index-DZ-IBsLu.js";const A={class:"flex flex-col bg-slate-900 rounded-xl border border-slate-800 shadow-xl overflow-hidden relative group/json"},L={class:"flex flex-col sm:flex-row sm:items-center justify-between px-3 py-2 bg-slate-800/80 border-b border-slate-700/50 gap-2"},N={class:"flex items-center gap-3"},J={class:"text-xs font-bold text-slate-400 uppercase tracking-widest pl-1"},V={class:"flex items-center justify-end gap-2 w-full sm:w-auto"},B={class:"relative w-full sm:w-64 text-slate-300"},K={class:"hidden sm:inline"},D={class:"p-4 pl-6 overflow-auto max-h-[500px] bg-[#0d1117] text-slate-300 custom-scrollbar"},M={key:1,class:"text-slate-500 italic text-xs py-2 text-center"},T={name:"JsonNode",props:{nodeKey:{type:[String,Number],default:""},value:{required:!0},isLast:{type:Boolean,default:!0},depth:{type:Number,default:0},search:{type:String,default:""},forceExpand:{type:Boolean,default:!1}},setup(e){const t=m(e.depth<3||e.forceExpand);j(()=>e.forceExpand,i=>{i&&(t.value=!0)});const o=()=>t.value=!t.value,s=n(()=>e.value!==null&&typeof e.value=="object"),a=n(()=>Array.isArray(e.value)),f=n(()=>e.value===null?"text-slate-500":typeof e.value=="string"?"text-emerald-400":typeof e.value=="number"?"text-amber-400":typeof e.value=="boolean"?"text-pink-400":"text-indigo-300"),l=n(()=>e.value===null?"null":typeof e.value=="string"?`"${e.value}"`:String(e.value)),c=n(()=>{if(!e.search)return!1;const i=e.search.toLowerCase();return!!(String(e.nodeKey).toLowerCase().includes(i)||!s.value&&l.value.toLowerCase().includes(i))}),p=n(()=>!e.search||c.value?!0:s.value?Object.entries(e.value).some(([i,u])=>{const v=e.search.toLowerCase();return i.toLowerCase().includes(v)||u!==null&&typeof u!="object"&&String(u).toLowerCase().includes(v)?!0:JSON.stringify(u).toLowerCase().includes(v)}):!1);return{isExpanded:t,toggle:o,isObject:s,isArray:a,typeClass:f,displayValue:l,hasMatch:c,shouldShow:p}},template:`
