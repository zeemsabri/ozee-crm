...
// Local state for the fields to be created
...
watch([selectedModel, localFields], ([newModel, newFields]) => {
    if (step.value) {
    ...
    <div class="space-y-4">
        ...
        <div>
            <div class="flex items-center justify-between">
                <label class="text-xs font-medium text-gray-700">Fields to create</label>
