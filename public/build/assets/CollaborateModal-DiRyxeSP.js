const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-BVX1Xzgm.js","assets/app-C940QSSY.css"])))=>i.map(i=>d[i]);
import{r as o,f as h,e as x,c as _,g as C,o as M,u as S,aD as k,aX as B,L as m,M as $}from"./app-BVX1Xzgm.js";import D from"./BaseModal-BU402Mr0.js";import{_ as O}from"./MultiSelectDropdown-B3VcmzFf.js";import{a as U}from"./presentationsApi-BHZmoWwq.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const j={__name:"CollaborateModal",props:{show:{type:Boolean,default:!1},presentation:{type:Object,required:!0}},emits:["close","updated"],setup(c,{emit:v}){const s=c,n=v,r=o(!1),d=o([]),i=o([]),u=o("editor"),l=o(!1);async function f(){try{r.value=!0;const a=await(typeof window<"u"&&window.axios?window.axios:(await B(async()=>{const{default:t}=await import("./app-BVX1Xzgm.js").then(w=>w.b5);return{default:t}},__vite__mapDeps([0,1]))).default).get("/api/users");d.value=(a.data||[]).map(t=>({value:t.id,label:t.name?`${t.name} <${t.email}>`:t.email}))}catch{m("Failed to load users")}finally{r.value=!1}}h(()=>{f(),p()});function p(){var a;const e=Array.isArray((a=s.presentation)==null?void 0:a.users)?s.presentation.users:[];i.value=e.map(t=>t.id)}x(()=>{var e;return(e=s.presentation)==null?void 0:e.users},()=>{p()});const b=_(()=>!l.value);async function y(){try{l.value=!0;const e=await U.syncCollaborators(s.presentation.id,i.value,u.value);$("Collaborators updated"),n("updated",(e==null?void 0:e.collaborators)||[]),n("close")}catch{m("Failed to update collaborators")}finally{l.value=!1}}const g=k({name:"CollaborateBody",components:{MultiSelectDropdown:O},template:`
    <div class="space-y-4">
      <div>
  ...
  `,setup(){return{users:d,selectedUserIds:i,role:u,saving:l,canSave:b,save:y,closeModal:()=>n("close"),loadingUsers:r}}});return(e,a)=>(M(),C(D,{isOpen:c.show,title:"Collaborate",onClose:a[0]||(a[0]=t=>e.$emit("close")),children:S(g)},null,8,["isOpen","children"]))}};export{j as default};
