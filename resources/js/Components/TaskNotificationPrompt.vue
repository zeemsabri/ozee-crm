                ...
                <div class="ml-3">
                    <p class="text-sm text-amber-800 font-medium">
                        <span v-if="overdueTasks > 0 && dueTodayTasks > 0">
                            You have {{ overdueTasks }} overdue {{ overdueTasks === 1 ? 'task' : 'tasks' }} and {{ dueTodayTasks }} {{ dueTodayTasks === 1 ? 'task' : 'tasks' }} due today.
                        </span>
                        <span v-else-if="overdueTasks > 0">
                            You have {{ overdueTasks }} overdue {{ overdueTasks === 1 ? 'task' : 'tasks' }} that require your attention.
                        </span>
                        <span v-else-if="dueTodayTasks > 0">
                            You have {{ dueTodayTasks }} {{ dueTodayTasks === 1 ? 'task' : 'tasks' }} due today.
                        </span>
                    </p>
                </div>
            </div>
