const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-BRSaGEek.js","assets/app-BcQtNIgg.css"])))=>i.map(i=>d[i]);
import{r as o,f as h,e as x,c as _,g as C,o as M,u as S,aD as k,aX as B,J as m,K as $}from"./app-BRSaGEek.js";import D from"./BaseModal-9Vgt98AM.js";import{_ as O}from"./MultiSelectDropdown-DbKzeNRp.js";import{a as U}from"./presentationsApi-0rHA0r-F.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const j={__name:"CollaborateModal",props:{show:{type:Boolean,default:!1},presentation:{type:Object,required:!0}},emits:["close","updated"],setup(c,{emit:v}){const s=c,n=v,r=o(!1),d=o([]),i=o([]),u=o("editor"),l=o(!1);async function f(){try{r.value=!0;const a=await(typeof window<"u"&&window.axios?window.axios:(await B(async()=>{const{default:t}=await import("./app-BRSaGEek.js").then(w=>w.b5);return{default:t}},__vite__mapDeps([0,1]))).default).get("/api/users");d.value=(a.data||[]).map(t=>({value:t.id,label:t.name?`${t.name} <${t.email}>`:t.email}))}catch{m("Failed to load users")}finally{r.value=!1}}h(()=>{f(),p()});function p(){var a;const e=Array.isArray((a=s.presentation)==null?void 0:a.users)?s.presentation.users:[];i.value=e.map(t=>t.id)}x(()=>{var e;return(e=s.presentation)==null?void 0:e.users},()=>{p()});const b=_(()=>!l.value);async function y(){try{l.value=!0;const e=await U.syncCollaborators(s.presentation.id,i.value,u.value);$("Collaborators updated"),n("updated",(e==null?void 0:e.collaborators)||[]),n("close")}catch{m("Failed to update collaborators")}finally{l.value=!1}}const g=k({name:"CollaborateBody",components:{MultiSelectDropdown:O},template:`
    <div class="space-y-4">
      <div>
