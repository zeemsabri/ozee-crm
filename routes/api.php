...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('admin/outstanding-docs', [\App\Http\Controllers\Api\TransactionsController::class, 'outstandingDocs'])->middleware('permission:view_project_transactions')->name('api.admin.outstanding-docs');
