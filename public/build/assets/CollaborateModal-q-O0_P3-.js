const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-DMAc5kaa.js","assets/app-CHDHXXWs.css"])))=>i.map(i=>d[i]);
import{r as o,b as h,m as x,l as _,q as C,o as M,u as S,aD as k,ba as B,M as m,N as $}from"./app-DMAc5kaa.js";import D from"./BaseModal-CcUY6X5n.js";import{_ as O}from"./MultiSelectDropdown-S5vGcGmG.js";import{a as U}from"./presentationsApi-Co8aljLW.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const j={__name:"CollaborateModal",props:{show:{type:Boolean,default:!1},presentation:{type:Object,required:!0}},emits:["close","updated"],setup(d,{emit:v}){const s=d,n=v,r=o(!1),c=o([]),i=o([]),u=o("editor"),l=o(!1);async function f(){try{r.value=!0;const a=await(typeof window<"u"&&window.axios?window.axios:(await B(async()=>{const{default:t}=await import("./app-DMAc5kaa.js").then(w=>w.bg);return{default:t}},__vite__mapDeps([0,1]))).default).get("/api/users");c.value=(a.data||[]).map(t=>({value:t.id,label:t.name?`${t.name} <${t.email}>`:t.email}))}catch{m("Failed to load users")}finally{r.value=!1}}h(()=>{f(),p()});function p(){var a;const e=Array.isArray((a=s.presentation)==null?void 0:a.users)?s.presentation.users:[];i.value=e.map(t=>t.id)}x(()=>{var e;return(e=s.presentation)==null?void 0:e.users},()=>{p()});const b=_(()=>!l.value);async function y(){try{l.value=!0;const e=await U.syncCollaborators(s.presentation.id,i.value,u.value);$("Collaborators updated"),n("updated",(e==null?void 0:e.collaborators)||[]),n("close")}catch{m("Failed to update collaborators")}finally{l.value=!1}}const g=k({name:"CollaborateBody",components:{MultiSelectDropdown:O},template:`
    <div class="space-y-4">
      <div>
