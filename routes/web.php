...
Route::get('/ozee-xero/callback', [\App\Http\Controllers\Admin\XeroConnectionController::class, 'callback'])
    ->name('xero.callback');
...
Route::middleware(['auth', 'verified'])->group(function () use ($sourceOptions) {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/financials/bills/{id}', [\App\Http\Controllers\Admin\FinancialController::class, 'showBill'])->name('financials.bills.show');
    ...
    // Lead Details Page
    Route::get('/leads/{leadId}', function ($leadId) {
        return Inertia::render('Admin/Leads/LeadDetails', [
            'id' => (int) $leadId,
        ]);
