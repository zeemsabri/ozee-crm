...
return [
    ...
    'description' => 'External API for payment integration and status tracking.',
    ...
    'auth' => [
        ...
        'placeholder' => '{YOUR_MAGIC_TOKEN}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Use the magic token provided to you in the <code>X-Magic-Token</code> header.',
    ],
