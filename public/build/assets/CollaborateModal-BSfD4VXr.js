const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-CDr3a6VS.js","assets/app-D23VLFrS.css"])))=>i.map(i=>d[i]);
import{r as o,f as h,e as x,c as _,g as C,o as M,u as S,aB as k,aV as B,J as m,N as $}from"./app-CDr3a6VS.js";import O from"./BaseModal-BHlAlgkN.js";import{_ as U}from"./MultiSelectDropdown-BBGkXTZm.js";import{a as A}from"./presentationsApi-iFHE9oiY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./ChevronDownIcon-DuQQUHcq.js";const j={__name:"CollaborateModal",props:{show:{type:Boolean,default:!1},presentation:{type:Object,required:!0}},emits:["close","updated"],setup(c,{emit:v}){const s=c,r=v,n=o(!1),d=o([]),i=o([]),u=o("editor"),l=o(!1);async function f(){try{n.value=!0;const a=await(typeof window<"u"&&window.axios?window.axios:(await B(async()=>{const{default:t}=await import("./app-CDr3a6VS.js").then(w=>w.b5);return{default:t}},__vite__mapDeps([0,1]))).default).get("/api/users");d.value=(a.data||[]).map(t=>({value:t.id,label:t.name?`${t.name} <${t.email}>`:t.email}))}catch{m("Failed to load users")}finally{n.value=!1}}h(()=>{f(),p()});function p(){var a;const e=Array.isArray((a=s.presentation)==null?void 0:a.users)?s.presentation.users:[];i.value=e.map(t=>t.id)}x(()=>{var e;return(e=s.presentation)==null?void 0:e.users},()=>{p()});const b=_(()=>!l.value);async function y(){try{l.value=!0;const e=await A.syncCollaborators(s.presentation.id,i.value,u.value);$("Collaborators updated"),r("updated",(e==null?void 0:e.collaborators)||[]),r("close")}catch{m("Failed to update collaborators")}finally{l.value=!1}}const g=k({name:"CollaborateBody",components:{MultiSelectDropdown:U},template:`
    <div class="space-y-4">
      <div>
