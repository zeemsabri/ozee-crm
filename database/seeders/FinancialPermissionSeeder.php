    ...
    public function run(): void
    {
        $permissionsByCategory = [
            ...
            'Financials' => [
                ...
                'delete_project_bills' => 'Delete (soft delete) project bills',
                'restore_project_bills' => 'Restore soft deleted project bills',
        ...
        $managerPermissions = [
            ...
            'delete_project_bills',
            'restore_project_bills',
